...
public sealed class WhisperProvider : IAudioProviderSource
{
    ...
    [
        new() { Id = "tiny", Name = "Whisper Tiny", Description = "Fastest model, lowest accuracy (39M params)", SourceUrl = "https://huggingface.co/openai/whisper-tiny", License = "MIT", EstimatedSize = "~75MB", EstimatedVram = "~1GB", EngineConfig = new() { ["model_name"] = "tiny" } },
        new() { Id = "base", Name = "Whisper Base", Description = "Good balance of speed and accuracy (74M params)", SourceUrl = "https://huggingface.co/openai/whisper-base", License = "MIT", EstimatedSize = "~150MB", EstimatedVram = "~1GB", EngineConfig = new() { ["model_name"] = "base" } },
        new() { Id = "small", Name = "Whisper Small", Description = "Better accuracy, moderate speed (244M params)", SourceUrl = "https://huggingface.co/openai/whisper-small", License = "MIT", EstimatedSize = "~500MB", EstimatedVram = "~2GB", EngineConfig = new() { ["model_name"] = "small" } },
        new() { Id = "medium", Name = "Whisper Medium", Description = "High accuracy, slower (769M params)", SourceUrl = "https://huggingface.co/openai/whisper-medium", License = "MIT", EstimatedSize = "~1.5GB", EstimatedVram = "~5GB", EngineConfig = new() { ["model_name"] = "medium" } },
        new() { Id = "large-v2", Name = "Whisper Large V2", Description = "Best accuracy for many languages (1.5B params)", SourceUrl = "https://huggingface.co/openai/whisper-large-v2", License = "MIT", EstimatedSize = "~3GB", EstimatedVram = "~10GB", EngineConfig = new() { ["model_name"] = "large-v2" } },
