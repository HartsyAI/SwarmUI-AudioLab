...
public sealed class CSMProvider : IAudioProviderSource
{
    ...
    [
        ...
        new() { Name = "transformers>=4.50.0", InstallName = "transformers>=4.50.0", ImportName = "transformers", Category = "tts" },
        new() { Name = "accelerate>=0.25.0", InstallName = "accelerate>=0.25.0", ImportName = "accelerate", Category = "tts" },
