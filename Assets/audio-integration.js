...
const AudioLabConfig = {
    ...
    archToCategory: {
        ...
        vibevoice_tts: { category: 'audiolab_tts', providerFlag: 'vibevoice_tts_params', extraFlags: ['tts_voice_ref', 'tts_streaming'] },
        ...
        cosyvoice_tts: { category: 'audiolab_tts', providerFlag: 'cosyvoice_tts_params', extraFlags: ['tts_voice_ref', 'tts_streaming'] },
